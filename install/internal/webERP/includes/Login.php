...
<td width="35%" valign ="top">
	<table width="100%" align="left" valign ="top" cellspacing="0" cellpadding="10" align="center">
        ...
        <tr>
        <td style="border-bottom: 1px dotted #000"><h4 style="margin: 0;pdiing:0;"><font face="Verdana, Arial, Helvetica, sans-serif"> ERP Module Login</strong></font></h4></td></tr>
...
<td width="35%" valign ="top"><table align="center" valign ="top" cellpadding="10" cellspacing="0" border="0" width="100%">
			...
			<input type="hidden" name="CompanyNameField" value="DBNAME">
