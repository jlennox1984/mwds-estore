...
if (isset($_SESSION['SupplierID'])){
	...
	echo "<BR><A HREF='$rootpath/PR_Select.php?" . SID . '&SelectedSupplier=' . $_SESSION['SupplierID'] . "'>" . _('Search Production Run Costings') . '</A>';
	...
	echo "<BR><A HREF='$rootpath/ProductionRunCosting.php?" . SID . "&NewProductionRunCosting=Yes'>" . _('Set Up A New Production Run Costing') . '</A>';
