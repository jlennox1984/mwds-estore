...
if (isset($_POST['CommitBatch'])){
  ...
  */
  ...
  if ($_SESSION['PaymentDetail']->SupplierID=='') {
	  ...
	  $TransType = 1;
//	  if ($_SESSION['PaymentDetail']->ChequeNum == 0 || $_SESSION['PaymentDetail']->ChequeNum == "" || !isset($_SESSION['PaymentDetail']->ChequeNum))
//	  {$ChequeNum = NULL;}
//	  else
//	  {
	  $ChequeNum = $_SESSION['PaymentDetail']->ChequeNum;
//	  }
