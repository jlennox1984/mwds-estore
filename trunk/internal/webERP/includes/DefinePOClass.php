...
Class PurchOrder {
	...
	function update_order_item($LineNo,
			...
			$this->LineItems[$LineNo]->PRNo = $PRNo;
...
/* PurchOrderDetails */
	...
	function LineDetails ($LineNo, $StockItem, $Controlled, $Serialised, $Qty, $ItemDescr,  $Prc, $UOM, $GLCode, $ReqDelDate, $ShiptRef =0, $PRRef =0, $PRNo =0, $JobRef, $QtyInv, $QtyRecd, $GLActName, $DecimalPlaces){
