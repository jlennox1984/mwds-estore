...
$cvcolumns = Array(Array('leaddetails:firstname:firstname:Leads_First_Name:V',
		   ...
		   Array('custbranch:brname:accountname:Accounts_Account_Name:V',
			 'custbranch:phoneno:phone:Accounts_Phone:V',
			 'custbranch:website:website:Accounts_Website:V',
			 'custbranch:rating:rating:Accounts_Rating:V',
			 'crmentity:smownerid:assigned_user_id:Accounts_Assigned_To:V'),

		   Array('custbranch:brname:accountname:Accounts_Account_Name:V',
                         'custbranch:phoneno:phone:Accounts_Phone:V',
                         'custbranch:website:website:Accounts_Website:V',
                         'custbranch:braddress3:bill_city:Accounts_City:V',
                         'crmentity:smownerid:assigned_user_id:Accounts_Assigned_To:V'),
...
$cvadvfilters = Array(
		      ...
		      Array(
                            Array('columnname'=>'custbranch:account_type:accounttype:Accounts_Type:V',
                                  'comparator'=>'e',
                                  'value'=>'Prospect'
                                 )
                           ),
