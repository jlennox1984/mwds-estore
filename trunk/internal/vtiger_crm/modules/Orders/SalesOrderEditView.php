...
$recalc= $_SERVER['PHP_SELF'] ;
$xtpl->assign("RECALC", $recalc);
...
//	$xtpl->assign("TAXVALUE", $tax_value);
	$xtpl->assign("TAXVALUE", $quote_focus->column_fields['txtTax']);
	$xtpl->assign("DISCOUNTVALUE", $quote_focus->column_fields['hdnDiscountTotal']);
	$xtpl->assign("ADJUSTMENTVALUE", $quote_focus->column_fields['freightcost']);
	$xtpl->assign("FREIGHTTAXVALUE", $quote_focus->column_fields['freighttax']);
...
else
{
	...
	$output .= '<tr id="row1" class="oddListRow">';
        $output .= '<td height="25" style="padding:3px;" nowrap><input size="30" id="txtProduct1" name="txtProduct1" type="text" readonly> <img src="'.$image_path.'search.gif" onClick=\'productPickList(this)\' align="absmiddle" style=\'cursor:hand;cursor:pointer\'></td>';
