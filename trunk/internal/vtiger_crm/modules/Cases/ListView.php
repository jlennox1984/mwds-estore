...
if(isset($_REQUEST['query']))
{
	...
	if(isset($name) && $name != "") array_push($where_clauses, "cases.name like '".$adb->quote($name)."%'");
	if(isset($account_name) && $account_name != "") array_push($where_clauses, "accounts.name like '".$adb->quote($account_name)."%'");
	if(isset($status) && $status != "") array_push($where_clauses, "cases.status = '".$adb->quote($status)."'");
	if(isset($number) && $number != "") array_push($where_clauses, "cases.number like '".$adb->quote($number)."%'");
