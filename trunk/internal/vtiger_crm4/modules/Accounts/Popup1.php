...
*/	
	...
	if(isset($website) && $website != "") array_push($where_clauses, "custbranch.website like ".PearDatabase::quote("%".$website."%"));
	if(isset($phone) && $phone != "") array_push($where_clauses, "(custbranch.phoneno like ".PearDatabase::quote("%".$phone."%")." OR custbranch.otherphone like ".PearDatabase::quote("%".$phone."%")." OR custbranch.faxno like ".PearDatabase::quote("%".$phone."%").")");
	...
	if(isset($ownership) && $ownership != "") array_push($where_clauses, "custbranch.ownership like ".PearDatabase::quote($ownership."%"));
...
if (!isset($_REQUEST['search_form']) || $_REQUEST['search_form'] != 'false') {
	...
	$search_form->assign("ALPHABETICAL",AlphabeticalSearch('Accounts','Popup1','name','true','basic',$popuptype));
...
$listview_header = getSearchListViewHeader1($focus,"Accounts",$url_string,$sorder,$order_by);
$xtpl->assign("LISTHEADER", $listview_header);


$listview_entries = getSearchListViewEntries1($focus,"Accounts",$list_result,$navigation_array);
