...
if($mass_merge != "")
{
  ...
  {
  	$query = "SELECT * FROM custbranch where custbranch.accountid = '".$mass_merge[$i]."'";
    ...
    //for custom fields
  	$sql2 = "select accountscf.* from accountscf inner join custbranch on custbranch.accountid = accountscf.accountid where custbranch.accountid = '".$mass_merge[$i]."'";
...
$query = "SELECT * FROM custbranch where custbranch.accountid = '".$_REQUEST['record'] ."'";
//$query = "SELECT * FROM custbranch where accountid = '".$_REQUEST['record'] ."'";
...
if($mass_merge == "")
{
  ...
  $sql2 = "select accountscf.* from accountscf inner join custbranch on custbranch.accountid = accountscf.accountid where custbranch.accountid = '".$_REQUEST['record'] ."'";
  $result2 = $adb->query($sql2);
  $numRows2 = $adb->num_fields($result2);
  $custom_field_values = $adb->fetch_array($result2);
