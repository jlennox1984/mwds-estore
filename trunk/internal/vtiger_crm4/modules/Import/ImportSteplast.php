...
//$seedUsersLastImport->list_fields = Array('accountid', 'brname', 'website', 'phone', 'email1', 'assigned_user_name', 'fax');
...
if($noofrows>1)
{
	...
	//$where = "users_last_import.assigned_user_id='{$current_user->id}' AND users_last_import.bean_type='Accounts' and users_last_import.bean_id=custbranch.accountid AND users_last_import.deleted=0";
