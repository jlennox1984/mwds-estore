...
echo get_module_title("SalesOrder", $mod_strings['LBL_MODULE_TITLE'], true); 

$submenu = array('LBL_SO_FORM_TITLE'=>'SalesOrderListView.php');
$sec_arr = array('SalesOrderListView.php'=>'SalesOrder'); 
echo "\n<BR>\n";
?>
...
<?php
	...
	$listView = "SalesOrderListView.php";
...
?>
 ...
 <tr>
   <td class="tabContent" style="padding:10"><div id="tabcontent1"><?php include ('modules/Orders/'.$listView); ?> </div>
   </td>
 </tr>
</table>
