...
$sql1 = "insert into products (productname) values ('testprod 1')";
$sql2 = "insert into products (productname) values ('testprod 1')";
$sql3 = "insert into products (productname) values ('testprod 2')";
$sql4 = "delete from stockmaster where productid>80";
$sql5 = 'select * from stockmaster';
...
(
	...
	[_closed] => 
	[_inited] => 
	[sql] => delete from stockmaster where productid>80
	[affectedrows] => 2
	[insertid] => 0
)
