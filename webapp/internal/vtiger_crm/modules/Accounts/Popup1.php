...
*/	
	...
	if(isset($website) && $website != "") array_push($where_clauses, "custbranch.website like ".$adb->quote("%".$website."%"));
	if(isset($phone) && $phone != "") array_push($where_clauses, "(custbranch.phoneno like ".$adb->quote("%".$phone."%")." OR custbranch.otherphone like ".$adb->quote("%".$phone."%")." OR custbranch.faxno like ".$adb->quote("%".$phone."%").")");
	...
	if(isset($ownership) && $ownership != "") array_push($where_clauses, "custbranch.ownership like ".$adb->quote($ownership."%"));
