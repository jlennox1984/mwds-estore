...
for($i=0;$i<$noofrows;$i++) 
{
  ...
  $open_activity_list[] = Array('name' => $adb->query_result($list_result,$i,'subject'),
 					...
 					'accountname' => $adb->query_result($list_result,$i,'brname'),
