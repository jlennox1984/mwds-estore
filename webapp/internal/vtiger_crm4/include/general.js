...
function emptyCheck1(fldName,fldLabel, fldType, fld2Name, fld3Name, fld4Name, fld5Name, fld6Name) {
	var currObj=getObj(fldName)
	var fld2=getObj(fld2Name)
	var fld3=getObj(fld3Name)
	var fld4=getObj(fld4Name)
	var fld5=getObj(fld5Name)
	var fld6=getObj(fld6Name)
	...
	var tmp1 = currObj.value.toUpperCase()
	tmp1 = tmp1.replace(/[^a-zA-Z 0-9]+/g,'');
//  tmp1 = tmp1.replace(/\<|\>|\"|\'|\%|\;|\(|\)|\&|\+|\-/g,""); 
...
//	var	tmp1 = clearText(tmp1)
		...
		//	tmp1 = tmp1.replace(/\s*/g,'');
			...
			var tmp2 = "000000" + fld6.value  
			tmp2 = tmp2.substring(10,5)
			fld2.value = tmp1 + tmp2
			fld3.value = ("--same--")
			fld4.value = tmp1 + tmp2
