...
<td width="35%" valign ="top">
	<table width="100%" align="left" valign ="top" cellspacing="0" cellpadding="10" align="center">
        <tr>
        <td style="border-bottom: 1px dotted #000"><h4 style="margin: 0;pdiing:0;"><font face="Verdana, Arial, Helvetica, sans-serif">Mahsie Demo CRM Module Login</strong></font></h4></td></tr>
	<tr><td>Administrator Account -</td></tr>
	<tr><td>username: admin</td></tr>
	<tr><td>password: admin</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>Employee Account -</td></tr>
	<tr><td>username: user</td></tr>
	<tr><td>password: user</td></tr>
	<tr><td></td></tr>
	<tr><td></td></tr>
	<tr><td></td></tr>
        </table></td>
...
<td width="35%" valign ="top">
	...
	<tr><td>This customer relationship management module is based on VTiger CRM 4.24.  It functions as a normal installation, but it is deeply integrated with webERP.  The programs are integrated in the following ways:<br /><br />
...
This was built for La Siembra Fair Trade Cooperative in Ottawa, Canada and is currently implemented.</td></tr>
