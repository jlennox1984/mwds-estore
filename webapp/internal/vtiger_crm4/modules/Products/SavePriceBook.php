...
$pb_name = $focus->column_fields["bookname"];
$pb_code = $focus->column_fields["pbcode"];
$pb_name = mysql_real_escape_string($pb_name);


$sql = "insert into salestypes values ('".$pb_code."', '" . $pb_name. "')";
