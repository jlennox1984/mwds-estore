...
<td width="35%" valign ="top">
	...
	<tr><td><strong>username:</strong> spartan</td></tr>
	<tr><td><strong>password:</strong> grenfell</td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td></td></tr>
	<tr><td></td></tr>
	<tr><td></td></tr>
...
<td width="35%" valign ="top">
	...
	<tr><td>This enterprise resource planning module is based on webERP 3.05.  It functions as a normal installation, but it is deeply integrated with Mahsie's CRM and CMS systems.  The programs are integrated in the following ways:<br /><br />
...
<td width="35%" valign ="top"><table align="center" valign ="top" cellpadding="10" cellspacing="0" border="0" width="100%">
			...
			<input type="hidden" name="CompanyNameField" value="muskoxen_spartan">
