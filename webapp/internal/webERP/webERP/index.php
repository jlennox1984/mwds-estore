...
?>
		<table border="0" width="100%">
			<tr>
					...
					<tr><td class="topBorder" width="5"><img src="../vtiger_crm/themes/blue/images/blank.gif"></td>
	...
	while ($i < count($ModuleLink)){
		...
		if ($_SESSION['ModulesEnabled'][$i]==1)	{
			...
			if ($ModuleLink[$i] == $_SESSION['Module']){
				...
				echo '<td align="right"><img src="../vtiger_crm/themes/blue/images/menu_on_start.gif"></td><td style="padding: 0px 0px;" align="center" background="../vtiger_crm/themes/blue/images/menu_on_tile.gif"><a class="currentTab" href="index.php?' . SID . '&Application='. $ModuleLink[$i] .'">' . $ModuleList[$i] . '</a></td><td><img src="../vtiger_crm/themes/blue/images/menu_on_end.gif"></td>';
				
				
			} else {
				echo '<td align="right"><img src="../vtiger_crm/themes/blue/images/menu_off_start.gif"></td><td style="padding: 0px 0px;" align="center" background="../vtiger_crm/themes/blue/images/menu_off_tile.gif"><a class="otherTab" href="index.php?' . SID . '&Application='. $ModuleLink[$i] .'">' . $ModuleList[$i] . '</a></td><td><img src="../vtiger_crm/themes/blue/images/menu_off_end.gif"></td>';
			}
		}
		$i++;
	}
	...
	?>
					<td class="topBorder" width="5"><img src="../vtiger_crm/themes/blue/images/blank.gif"></td>
                    </tr>
				</table></div>
			</td>
			</tr>
				...
				<table width="100%">
					...
					<td class="menu_group_items">
						<table width="100%"class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/SelectCustomer2.php?' . SID . "'><LI>" . _('Create Invoice Applied to GL') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
				...
				<table width="100%">
					...
					<td class="menu_group_items">
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/StockAdjustments2.php?' . SID . "'><LI>" . _('Inventory Adjustments SPECIAL') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
				...
				<table width="100%">
					...
					<td class="menu_group_items">
						<table width="100%" class="table_index">
							<tr>
							 <td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . "/PR_Header.php?&NewPR=Yes'><LI>" . _('Create New Item Assembly') . "</LI></A>"; ?>
							</td>
							</tr>
							<tr>
							 <td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/PR_SelectProductionRun.php?' . SID . "'><LI>" . _('Select An Item Assembly') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo '<A HREF="' . $rootpath . '/ProductionRunCosting.php?&NewProductionRunCosting=Yes"><LI>' . _('Create New Production Run') . '</LI></A>'; ?>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
								<?php echo "<A HREF='" . $rootpath . '/PR_Select.php?' . SID . "'><LI>" . _('Select A Production Run') . "</LI></A>"; ?>
							</td>
							</tr>
						</table>
					</td>
				...
				<table width="100%">		<!-- Gereral Ledger Option Headings-->
					...
					<td class="menu_group_items">  <!-- Gereral inquiry options -->
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<A HREF="GLAccountInquiryUS.php"><li>US Account Inquiry</li></a>
							</td>
							</tr>
							<tr>
							<td class="menu_group_item">
					...
					<td class="menu_group_items">  <!-- Gereral Ledger Maintenance options -->
						<table width="100%" class="table_index">
							...
							<tr>
							<td class="menu_group_item">
								<?php echo "<a href='" . $rootpath . '/Budget.php?' .SID . "'><li>" . _('GL Budget Entry') . '</li></a>'; ?>
							</td>
							</tr>
