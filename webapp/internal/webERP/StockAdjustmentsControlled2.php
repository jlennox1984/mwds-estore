...
if (!isset($_SESSION['Adjustment'])) {
	...
	echo '<CENTER><A HREF="' . $rootpath . '/StockAdjustments2.php?' . SID . '&NewAdjustment=Yes">'. _('Enter A Stock Adjustment'). '</A><br>';
...
if ( $LineItem->Controlled != 1 ){
	echo '<CENTER><A HREF="' . $rootpath . '/StockAdjustments2.php?' . SID . '&NewAdjustment=Yes">'._('Enter A Stock Adjustment').'</A></CENTER>';
...
echo '<br><a href="'.$rootpath.'/StockAdjustments2.php?'  . SID .'">' . _('Back to Adjustment Screen') . '</A>';
