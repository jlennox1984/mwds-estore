...
/**
*
* @version $Id: ps_checkout.php 677 2007-02-11 19:42:40Z soeren_nb $
* @package VirtueMart
* @subpackage classes
...
//ERP CODE BEGINS - CREATE CRM ENTRY FOR SO 

		$db->query( 'UPDATE crmentity_seq SET id = id+1 ' );
		
		$db->query( 'select id from crmentity_seq ' );
	...
	** name: get_accountid()
	***************************************************************************/
	function get_accountid($user_id) {
		$db = new ps_DB;

		$q = "SELECT accountid FROM custbranch WHERE employees='$user_id'";

		$db->query($q);
		$db->next_record();

		$accountid = $db->f("accountid");
	...
	** name: get_branchcode()
	***************************************************************************/
	function get_branchcode($user_id) {
		$db = new ps_DB;

		$q = "SELECT branchcode FROM custbranch WHERE employees='$user_id'";

		$db->query($q);
		$db->next_record();

		$branchcode = $db->f("branchcode");
	...
	** name: get_debtorno()
	***************************************************************************/
	function get_debtorno($user_id) {
		$db = new ps_DB;

		$q = "SELECT debtorno FROM custbranch WHERE employees='$user_id'";

		$db->query($q);
		$db->next_record();

		$debtorno= $db->f("debtorno");
	...
	***************************************************************************/
	function get_company($user_id) {
		...
		$q = "SELECT company FROM jos_vm_user_info WHERE user_id='$user_id'";
	...
	***************************************************************************/
	function get_firstname($user_id) {
		...
		$q = "SELECT first_name FROM jos_vm_user_info WHERE user_id='$user_id'";
	...
	** name: get_lastname()
	***************************************************************************/
	function get_lastname($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT last_name FROM jos_vm_user_info WHERE user_id='$user_id'";
	...
	***************************************************************************/
	function get_phone($user_id) {
		...
		$q = "SELECT phone_1 FROM jos_vm_user_info WHERE user_id='$user_id'";
	...
	***************************************************************************/
	function get_email($user_id) {
		...
		$q = "SELECT user_email FROM jos_vm_user_info WHERE user_id='$user_id'";
	...
	***************************************************************************/
	function get_location($user_id) {
		...
		$q = "SELECT defaultlocation FROM custbranch WHERE employees='$user_id'";

		$db->query($q);
		$db->next_record();

		$location = $db->f("defaultlocation");
		return($location);
	}
	...
	** name: get_billadd1()
	***************************************************************************/
	function get_billadd1($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT address_1 FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='BT'";

		$db->query($q);
		$db->next_record();

		$braddress1 = $db->f("address_1");
		return($braddress1);
	}
	...
	** name: get_billadd2()
	***************************************************************************/
	function get_billadd2($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT address_2 FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='BT'";

		$db->query($q);
		$db->next_record();

		$braddress2 = $db->f("address_2");
		return($braddress2);
	}
	...
	** name: get_billadd3()
	***************************************************************************/
	function get_billadd3($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT city FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='BT'";

		$db->query($q);
		$db->next_record();

		$braddress3 = $db->f("city");
		return($braddress3);
	}
	...
	** name: get_billadd4()
	***************************************************************************/
	function get_billadd4($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT state FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='BT'";

		$db->query($q);
		$db->next_record();

		$braddress4 = $db->f("state");
		return($braddress4);
	}
	...
	** name: get_billadd5()
	***************************************************************************/
	function get_billadd5($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT country FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='BT'";

		$db->query($q);
		$db->next_record();

		$braddress5 = $db->f("country");
		return($braddress5);
	}
	...
	** name: get_billadd6()
	***************************************************************************/
	function get_billadd6($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT zip FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='BT'";
	...
	** name: get_shipadd1()
	***************************************************************************/
	function get_shipadd1($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT address_1 FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='ST'";

		$db->query($q);
		$db->next_record();

		$shipaddress1 = $db->f("address_1");
		return($shipaddress1);
	}
	...
	** name: get_shipadd2()
	***************************************************************************/
	function get_shipadd2($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT address_2 FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='ST'";

		$db->query($q);
		$db->next_record();

		$shipaddress2 = $db->f("address_2");
		return($shipaddress2);
	}
	...
	** name: get_shipadd3()
	***************************************************************************/
	function get_shipadd3($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT city FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='ST'";

		$db->query($q);
		$db->next_record();

		$shipaddress3 = $db->f("city");
		return($shipaddress3);
	}
	...
	** name: get_shipadd4()
	***************************************************************************/
	function get_shipadd4($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT state FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='ST'";

		$db->query($q);
		$db->next_record();

		$shipaddress4 = $db->f("state");
		return($shipaddress4);
	}
	...
	** name: get_shipadd5()
	***************************************************************************/
	function get_shipadd5($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT country FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='ST'";

		$db->query($q);
		$db->next_record();

		$shipaddress5 = $db->f("country");
		return($shipaddress5);
	}
	...
	** name: get_shipadd6()
	***************************************************************************/
	function get_shipadd6($user_id) {
		$db = new ps_DB;

		
		$q = "SELECT zip FROM jos_vm_user_info WHERE user_id='$user_id' and address_type='ST'";

		$db->query($q);
		$db->next_record();

		$shipaddress6 = $db->f("zip");
		return($shipaddress6);
	}
...
/**************************************************************************
	** name: get_prodid()
	***************************************************************************/
	function get_prodid($special2) {
		$db = new ps_DB;

		
		$q = "SELECT productid FROM stockmaster WHERE special2='$special2'";

		$db->query($q);
		$db->next_record();

		$prodid= $db->f("productid ");
		return($prodid);
	}
...
/**************************************************************************
	** name: get_vsoid()
	***************************************************************************/
	function get_vsoid($order_id) {
		$db = new ps_DB;

		
		$q = "SELECT salesorderid FROM salesorders WHERE orderno='$order_id'";

		$db->query($q);
		$db->next_record();

		$vsoid = $db->f("salesorderid");
		return($vsoid);
	}
		...
		$accountid = get_accountid($user_id);


	

		$db->query( "INSERT INTO crmentity (crmid,smcreatorid,smownerid,setype,description,createdtime,modifiedtime) VALUES ( $soid,'1','1','SalesOrders','',(CURRENT_TIMESTAMP),(CURRENT_TIMESTAMP) ) " );
		$db->next_record();

//		$db->query( "INSERT INTO test (testid) VALUES ($accountid)");
//		$db->next_record();

//		$contactid = get_contactid($auth["user_id"]);

		$company = get_company($auth["user_id"]);

		$branchcode = get_branchcode($auth["user_id"]);

		$debtorno = get_debtorno($auth["user_id"]);


		
		$firstname = get_firstname($auth["user_id"]);

		$lastname = get_lastname($auth["user_id"]);

		$fullname = $firstname . ' ' . $lastname;

		

		$email = get_email($auth["user_id"]);
		...
		$discounttotal = $payment_discount + $coupon_discount;


		$braddress1 = get_billadd1($auth["user_id"]);
		$braddress2 = get_billadd2($auth["user_id"]);
		$braddress3 = get_billadd3($auth["user_id"]);
		$braddress4 = get_billadd4($auth["user_id"]);
		$braddress5 = get_billadd5($auth["user_id"]);
		$braddress6 = get_billadd6($auth["user_id"]);
		
		$shipaddress1 = get_shipadd1($auth["user_id"]);
		$shipaddress2 = get_shipadd2($auth["user_id"]);
		$shipaddress3 = get_shipadd3($auth["user_id"]);
		...
		if ($braddress2 == '' || (!isset($braddress2)))
		{$braddress2=$shipaddress2;}
		
		if ($braddress3 == '' || (!isset($braddress3)))
		{$braddress3=$shipaddress3;}
		
		if ($braddress4 == '' || (!isset($braddress4)))
		{$braddress4=$shipaddress4;}
		
		if ($braddress5 == '' || (!isset($braddress5)))
		{$braddress5=$shipaddress5;}
		
		if ($braddress6 == '' || (!isset($braddress6)))
		{$braddress6=$shipaddress6;}
		

		if ($shipaddress1 == '' || (!isset($shipaddress1)))
		{$shipaddress1=$braddress1;}
		
		if ($shipaddress2 == '' || (!isset($shipaddress2)))
		{$shipaddress2=$braddress2;}
		
		if ($shipaddress3 == '' || (!isset($shipaddress3)))
		{$shipaddress3=$braddress3;}
		
		if ($shipaddress4 == '' || (!isset($shipaddress4)))
		{$shipaddress4=$braddress4;}
		
		if ($shipaddress5 == '' || (!isset($shipaddress5)))
		{$shipaddress5=$braddress5;}
		
		if ($shipaddress6 == '' || (!isset($shipaddress6)))
		{$shipaddress6=$braddress6;}
		
$mysqlDatetime1 = date("Y-m-d G:i:s", $timestamp);
		




  		$db->query("INSERT into salesorders (orderno, debtorno, branchcode, customerref, comments, orddate, ordertype, shipvia, deliverto, deladd1, deladd2, deladd3, deladd4, deladd5, deladd6, contactphone, contactemail, freightcost, freighttax, fromstkloc, duedate, deliverydate, deliverblind, accountid, salesorderid, sostatus, subject, subtotal, salestax, discounttotal, total) VALUES ('" . $order_id . "', '" .$debtorno . "',  '" .$branchcode . "', 'WEB' ,'" . $comments . "', '" .$mysqlDatetime1. "', 'DE', '1', '" . $fullname . "', '" .$shipaddress1 . "', '" .$shipaddress2 . "', '" .$shipaddress3 . "', '" .$shipaddress4 . "', '" .$shipaddress6 . "', '" .$shipaddress5 . "', '" .$phone . "', '" .$email . "', '" .$order_shipping . "', '" .$order_shipping_tax . "', '" .$location . "', '" .$mysqlDatetime1. "', '" .$mysqlDatetime1. "',  1, '" . $accountid . "', '" . $soid . "', 'Created', 'WWW" . $soid . "', $order_subtotal, $order_tax, $discounttotal, $order_total)");		
		$db->next_record();



  		$db->query("INSERT INTO sobillads (sobilladdressid, bill_street, bill_street2, bill_city, bill_state, bill_code, bill_country) VALUES ('" .$soid . "', '" .$braddress1 . "', '" .$braddress2 . "', '" .$braddress3 . "', '" .$braddress4 . "', '" .$braddress6 . "', '" .$braddress5 . "')");
		$db->next_record();


  		$db->query("INSERT INTO salesordercf (salesorderid) VALUES ('" . $soid . "')");
    ...
    */
		...
		$stockid=$dboi->f("product_sku");
		$special2=$cart[$i]["product_id"];
		$vsoid = get_vsoid($order_id);
		
		$prodid=get_prodid($cart[$i]["product_id"]);
	
		
		$db->query( "select productid from stockmaster where stockid='" . $stockid . "'" );
		
		$vproductid = $db->loadResult();



		$narrative = $dboi->f("product_name");
		$ordqty = $cart[$i]["quantity"];
		
		$db->query( "INSERT INTO test (testid, testtext) VALUES ('$vproductid ','$prodid')");
		$db->next_record();

	
		$db->query( "INSERT INTO salesorderdetails (orderlineno, orderno, stkcode, unitprice, quantity, discountpercent, narrative, salesorderid, productid)
 VALUES ('$i', '$order_id', '$stockid', '$product_price', '$ordqty', '0', '$narrative', '$soid', '$vproductid')");
		$db->next_record();
