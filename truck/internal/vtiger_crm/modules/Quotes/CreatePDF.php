...
$pdf->Output('Q'.$quote_id.'_'.$account_name.'_'.date('Ymd').'.pdf','D'); //added file name to make it work in IE, also forces the download giving the user the option to save
