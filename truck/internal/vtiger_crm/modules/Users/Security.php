...
//Account Details -- START
 //Block1
 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'brname','custbranch',1,'2','brname','Account Name',1,0,0,100,1,1,1,'V~M')");	
 ...
 //Block 2
 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'braddress1','custbranch',1,'21','bill_street','Billing Address',1,0,0,100,1,2,1,'V~O')");
 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'brpostaddr1','custbranch',1,'21','ship_street','Shipping Address',1,0,0,100,2,2,1,'V~O')");

 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'braddress3','custbranch',1,'1','bill_city','City',1,0,0,100,3,2,1,'V~O')");
 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'brpostaddr3','custbranch',1,'1','ship_city','City',1,0,0,100,4,2,1,'V~O')");

 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'braddress4','custbranch',1,'1','bill_state','State',1,0,0,100,5,2,1,'V~O')");
 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'brpostaddr4','custbranch',1,'1','ship_state','State',1,0,0,100,6,2,1,'V~O')");

 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'braddress6','custbranch',1,'1','bill_code','Code',1,0,0,100,7,2,1,'V~O')");
 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'brpostaddr6','custbranch',1,'1','ship_code','Code',1,0,0,100,8,2,1,'V~O')");


 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'braddress5','custbranch',1,'1','bill_country','Country',1,0,0,100,9,2,1,'V~O')");
 $this->db->query("insert into field values (6,".$this->db->getUniqueID("field").",'brpostaddr5','custbranch',1,'1','ship_country','Country',1,0,0,100,10,2,1,'V~O')");
...
//Block1 -- Start
 ...
 $this->db->query("insert into field values (14,".$this->db->getUniqueID("field").",'description','stockmaster',1,'2','description','Product Name',1,0,0,100,1,1,1,'V~M')");
 ...
 $this->db->query("insert into field values (14,".$this->db->getUniqueID("field").",'categoryid','products',1,'15','categoryid','Product Category',1,0,0,100,4,1,1,'V~O')");
