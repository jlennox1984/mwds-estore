...
$query="select stockmaster.description,stockmaster.unit_price,invoiceproductrel.* from invoiceproductrel inner join stockmaster on stockmaster.productid=invoiceproductrel.productid where invoiceid=".$id;
...
for($i=1;$i<=$num_rows;$i++)
{
	...
	$temp_data['description'] = $productname;
	$temp_data['qty'] = $qty;
...
function setProductDetails($ivHeader,$ivData)
{
	...
	{
    		$this->Cell(38,6,$value['description'],0,0,'L',0);
