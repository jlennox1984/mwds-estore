...
function checkForDuplicates($prefix){
	...
	if(isset($_POST[$prefix.'first_name']) && !empty($_POST[$prefix.'first_name']) && isset($_POST[$prefix.'last_name']) && !empty($_POST[$prefix.'last_name'])){	
		$query = $baseQuery ."  (first_name='". $adb->quote($_POST[$prefix.'first_name']) . "' and last_name = '". $adb->quote($_POST[$prefix.'last_name']) ."')";
	}else{
			$query = $baseQuery ."  last_name = '". $adb->quote($_POST[$prefix.'last_name']) ."'";
	}
	if(isset($_POST[$prefix.'email1']) && !empty($_POST[$prefix.'email1'])){	
		...
		$query = $baseQuery. "  email1='". $_POST[$prefix.'email1'] . "' or email2 = '". $_POST[$prefix.'email1'] ."'";
			...
			$query .= "or email1='". $adb->quote($_POST[$prefix.'email1']) . "' or email2 = '". $adb->quote($_POST[$prefix.'email1']) ."'";		
		}
	}
	if(isset($_POST[$prefix.'email2']) && !empty($_POST[$prefix.'email2'])){
		if(empty($query))	{
			$query = $baseQuery. "  email1='".$adb->quote( $_POST[$prefix.'email2']) . "' or email2 = '". $adb->quote($_POST[$prefix.'email2']) ."'";
		}else{
			$query .= "or email1='". $adb->quote($_POST[$prefix.'email2']) . "' or email2 = '". $adb->quote($_POST[$prefix.'email2']) ."'";	
		}
