...
class SalesOrder extends CRMEntity {
	...
	var $table_name = "salesorders";
	var $tab_name = Array('crmentity','salesorders','sobillads','salesordercf');
	var $tab_name_index = Array('crmentity'=>'crmid','salesorders'=>'salesorderid','sobillads'=>'sobilladdressid','salesordercf'=>'salesorderid');
	...
	var $additional_column_fields = Array('orderno', 'assigned_user_name', 'smownerid', 'opportunity_id', 'case_id', 'contact_id', 'task_id', 'note_id', 'meeting_id', 'call_id', 'email_id', 'parent_name', 'member_id' );

	// This is the list of fields that are in the lists.
	var $list_fields = Array(
				'Order Id'=>Array('salesorders'=>'orderno'),
				'Subject'=>Array('salesorders'=>'subject'),
				'Account Name'=>Array('custbranch'=>'accountid'), 
				'Quote Name'=>Array('quotes'=>'quoteid'), 
				'Total'=>Array('salesorders'=>'total'),
	...
	var $search_fields = Array(
				...
				'Subject'=>Array('salesorders'=>'subject'),
				'Account Name'=>Array('custbranch'=>'accountid'),
				'Quote Name'=>Array('salesorders'=>'quoteid') 
				);
