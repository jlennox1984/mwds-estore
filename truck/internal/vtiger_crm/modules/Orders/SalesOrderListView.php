...
$comboFieldNames = Array('manufacturer'=>'manufacturer_dom'
                      ,'categoryid'=>'productcategory_dom');
...
if(isset($_REQUEST['query']) && $_REQUEST['query'] != '' && $_REQUEST['query'] == 'true')
{
	...
	{
		array_push($where_clauses, "salesorders.subject like ".$adb->quote($subject.'%'));
...
if($viewid != "0")
{
	...
	$vtlog->logthis("in sales order list ".$listquery,'info');  
	$vtlog->logthis("in sales order list_ ".$list_query,'info');  

	
}else
{
	$list_query = getListQuery("SalesOrder");
	$vtlog->logthis("in sales order list ELSE ".$list_query,'info');  
...
$vtlog->logthis("in sales order list query ".$list_query,'info');  
$vtlog->logthis("in sales order list result ".$list_result,'info');  
...
$vtlog->logthis("in sales order record string ".$record_string,'info');  
