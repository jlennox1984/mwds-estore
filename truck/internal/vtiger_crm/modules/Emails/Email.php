...
class Email extends CRMEntity {
  ...
  {
	$query = 'SELECT custbranch.accountid, custbranch.brname, custbranch.account_type, crmentity.modifiedtime from custbranch inner join seactivityrel on seactivityrel.crmid=custbranch.accountid inner join crmentity on crmentity.crmid=custbranch.accountid and seactivityrel.activityid='.$id;
