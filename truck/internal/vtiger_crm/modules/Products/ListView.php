...
if(isset($_REQUEST['query']) && $_REQUEST['query'] != '' && $_REQUEST['query'] == 'true')
{
	...
	if (isset($productcategory) && $productcategory !='' && $productcategory !='--None--')
        {
		array_push($where_clauses, "categoryid like ".$adb->quote($productcategory.'%'));
...
//Combo Fields for Manufacturer and Category are moved from advanced to Basic Search
        ...
        if (isset($_REQUEST['advanced']) && $_REQUEST['advanced'] == 'true')
	{
		...
		$search_form->assign("ALPHABETICAL",AlphabeticalSearch('Products','index','description','true','advanced',"","","","",$viewid));
	...
	{
		$search_form->assign("ALPHABETICAL",AlphabeticalSearch('Products','index','description','true','basic',"","","","",$viewid));
