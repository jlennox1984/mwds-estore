...
*/
  ...
  function get_summary_text()
	...
	function get_pricebook_products($id)
         {                                                                                                                     
         $query = 'select stockmaster.productid, stockmaster.description, stockmaster.stockid, stockmaster.commissionrate, stockmaster.qty_per_unit, stockmaster.unit_price, crmentity.crmid, crmentity.smownerid,prices.price from stockmaster inner join prices on stockmaster.productid = prices.productid inner join crmentity on crmentity.crmid = stockmaster.productid inner join pricebook on pricebook.pricebookid = prices.pricebookid  where pricebook.pricebookid = '.$id.' and crmentity.deleted = 0'; 
