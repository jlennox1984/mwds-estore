...
$query = "select stockmaster.productid,stockmaster.unit_price,stockmaster.description,stockmaster.categoryid,products.longdescription,stockmaster.qty_per_unit,stockmaster.commissionrate,stockmaster.discontinued from stockmaster where stockmaster.productid = ".$productid;
...
$xtpl->assign("NAME",$adb->query_result($productresult,0,'description'));
$xtpl->assign("DESCRIPTION",$adb->query_result($productresult,0,'longdescription'));
