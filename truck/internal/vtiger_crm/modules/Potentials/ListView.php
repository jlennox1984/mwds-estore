...
//upto this added for Custom Field
	...
	if(isset($amount) && $amount != "") {
			array_push($where_clauses, "potential.amount like ".$adb->quote($amount.'%')."");
			$url_string .= "&amount=".$amount;
	}
	if(isset($nextstep) && $nextstep != "") {
			array_push($where_clauses, "potential.nextstep like ".$adb->quote($nextstep.'%')."");
	...
	if(isset($probability) && $probability != "") {
			array_push($where_clauses, "potential.probability like ".$adb->quote($probability.'%')."");
