...
if(isset($_REQUEST['query']) && $_REQUEST['query'] == 'true')
{
	...
	if(isset($name) && $name != '')
	{
		array_push($where_clauses, "notes.title like ".$adb->quote($name.'%')."");
	...
	if(isset($contact_name) && $contact_name != '')
	{
		...
		foreach ($contact_names as $name) {
			array_push($where_clauses, "(contactdetails.firstname like ".$adb->quote($name.'%')." OR contactdetails.lastname like ".$adb->quote($name.'%').")");
		}
