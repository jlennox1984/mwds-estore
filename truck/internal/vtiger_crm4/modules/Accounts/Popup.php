...
*/	
	...
	if(isset($address_city) && $address_city != ""){
		array_push($where_clauses, "(custbranch.braddress3 like ".PearDatabase::quote("%".$address_city."%")." OR accountshipads.brpostaddr3 like ".PearDatabase::quote($address_city."%").")");
