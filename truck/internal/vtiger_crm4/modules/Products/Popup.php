...
$xtpl->assign("ACCOUNTID",$accountid);
...
// else {$rowid = $_REQUEST["curr_row"];}
$xtpl->assign("ROWID",$row_id);
...
//	$search_query="select * from products inner jon crmentity on crmentity.crmid=products.productid where crmentity.deleted =0";
	...
	{
		$search_query .= " and stockid like '%".$productcode."%'";
...
$navigationOutput = getTableHeaderNavigation1($navigation_array, $url_string,"Products","Popup",$accountid,$_REQUEST["accountid"]);
$xtpl->assign("NAVIGATION", $navigationOutput);
$xtpl->assign("RECORD_COUNTS", $record_string);



$xtpl->assign("ALPHABETICAL",AlphabeticalSearch1('Products','Popup&smodule=$smodule','description','true','basic',$accountid,$_REQUEST['accountid'],$row_id,$_REQUEST['curr_row'],$popuptype,$_REQUEST['recordid'],$_REQUEST['return_module']));
$xtpl->parse("main");
$xtpl->out("main");
