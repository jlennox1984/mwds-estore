...
$submenu = array('LBL_PRODUCTS_TITLE'=>'ListView.php','LBL_PRICEBOOK_TITLE'=>'PriceBookListView.php');
$sec_arr = array('ListView.php'=>'Products','PriceBookListView.php'=>'PriceBook'); 
echo "\n<BR>\n";
?>
...
?>
 ...
 <tr>
   <td class="tabContent" style="padding:10"><div id="tabcontent1"><?php include ('modules/Products/'.$listView); ?> </div>
   </td>
 </tr>
</table>
