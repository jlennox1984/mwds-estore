...
$query="select stockmaster.description,stockmaster.unit_price,poproductrel.* from poproductrel inner join stockmaster on stockmaster.productid=poproductrel.productid where purchaseorderid=".$id;
