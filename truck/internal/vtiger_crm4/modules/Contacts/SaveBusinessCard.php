...
if(($acctname != '') && ($lastname != ''))
{
  ...
  $sql_insertacct = "insert into custbranch(accountid,brname,phone,website,braddress1,braddress2,braddress3, braddress4,braddress6,braddress5,brpostaddr1,brpostaddr3,brpostaddr4,brpostaddr6,brpostaddr5) values(".$account_id.",'".$acctname."','".$acctphone."','".$acctwebsite ."', '', '', '', '', '', '', '', '', '', '')";
...
else if(($acctname != '') && ($lastname == ''))
{
  ...
  $sql_insertacct = "insert into account(accountid,brname,phone,website) values(".$id.",'".$acctname."','".$acctphone."','".$acctwebsite ."')";
