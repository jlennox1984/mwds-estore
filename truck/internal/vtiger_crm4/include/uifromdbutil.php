...
function getTableHeaderNavigation1($navigation_array, $url_qry,$module='',$action_val='index',$viewid='',$accountid,$accountid2)
{

	global $vtlog;
$vtlog->logthis("TableHeader Account ID".$accountid,"info");
	$vtlog->logthis("TableHeader Account ID".$accountid2,"info");
	...
	if(isset($navigation_array['prev']))
	{
		$output .= '<a href="index.php?module='.$dir_name.'&action='.$action_val.$url_qry.'&start=1&accountid='.$accountid.'&viewname='.$viewid.'" title="First"><img src="'.$image_path.'start.gif" border="0" align="absmiddle"></a>&nbsp;';
		$output .= '<a href="index.php?module='.$dir_name.'&action='.$action_val.$url_qry.'&start='.$navigation_array['prev'].'&accountid='.$accountid.'&viewname='.$viewid.'"><img src="'.$image_path.'previous.gif" border="0" align="absmiddle"></a>&nbsp;';
	...
	if(isset($navigation_array['next']))
	{
		$output .= '<a href="index.php?module='.$dir_name.'&action='.$action_val.$url_qry.'&start='.$navigation_array['next'].'&accountid='.$accountid.'&viewname='.$viewid.'"><img src="'.$image_path.'next.gif" border="0" align="absmiddle"></a>&nbsp;';
		$output .= '<a href="index.php?module='.$dir_name.'&action='.$action_val.$url_qry.'&start='.$navigation_array['end'].'&accountid='.$accountid.'&viewname='.$viewid.'"><img src="'.$image_path.'end.gif" border="0" align="absmiddle"></a>&nbsp;';
	}
	else
	{
		$output .= '<img src="'.$image_path.'next_disabled.gif" border="0" align="absmiddle">&nbsp;';
