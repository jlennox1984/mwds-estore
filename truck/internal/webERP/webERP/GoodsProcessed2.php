...
//$StockGLCodes = GetStockGLCode($_SESSION['PR']->StockNo,$db);
				...
				$SQL = "INSERT INTO gltrans (type,
						...
						VALUES (25,
							...
							'PR: " . DB_escape_string($_SESSION['PR']->PRNo) . " " . DB_escape_string($_SESSION['PR']->SupplierID) . " - " . DB_escape_string($_SESSION['PR']->StockNo) . " - " . DB_escape_string($Description) . " x " . DB_escape_string($_SESSION['PR']->RecdQty) . " @ " . number_format($CurrentStandardCost,2) . "',
