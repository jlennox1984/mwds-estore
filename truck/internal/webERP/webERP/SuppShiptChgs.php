...
if (isset($_POST['AddShiptChgToInvoice'])){
	...
	if ($InputError == False){
		$_SESSION['SuppTrans']->Add_Shipt_To_Trans($_POST['ShiptRef'], $_POST['Amount'],$_POST['InvoiceType']);
...
foreach ($_SESSION['SuppTrans']->Shipts as $EnteredShiptRef){
	...
	echo '<TR><TD>' . $EnteredShiptRef->ShiptRef . '</TD>
		<TD ALIGN=RIGHT>' . number_format($EnteredShiptRef->Amount,2) . "</TD><TD>" . $EnteredShiptRef->InvoiceType . "</TD>
