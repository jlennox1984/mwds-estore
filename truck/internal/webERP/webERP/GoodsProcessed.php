...
/*first the debit using the GLCode in the PO detail record entry*/
				...
				$SQL = "INSERT INTO gltrans (type,
						...
						VALUES (25,
							...
							" . $PeriodNo . ",
							" . $OrderLine->GLCode . ",
							'PR: " . DB_escape_string($_SESSION['PR']->PRNo) . " " . DB_escape_string($_SESSION['PR']->SupplierID) . " - " . DB_escape_string($OrderLine->StockID) . " - " . DB_escape_string($OrderLine->ItemDescription) . " x " . DB_escape_string(-$OrderLine->ReceiveQty) . " @ " . number_format($CurrentStandardCost,2) . "',
