...
echo "</TABLE><BR><A HREF='$rootpath/SupplierInvoice2.php?" . SID ."'>" . _('Back to Invoice Entry') . '</A><HR>';
...
if (DB_num_rows($GRNResults)==0){
	...
	echo "<P><A HREF='$rootpath/PO_SelectOSPurchOrder2.php?" . SID . 'SupplierID=' . $_SESSION['SuppTrans']->SupplierID ."'>" . _('Select Purchase Orders to receive') .'</A>';
	include('includes/footer.inc');
	exit;
}
