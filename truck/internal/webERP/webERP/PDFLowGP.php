...
if (isset($_POST['PrintPDF'])) {
	...
	$SQL = "SELECT stockmaster.categoryid, 
                       ...
                       (stockmoves.price*(1-stockmoves.discountpercent)) - (stockmaster.materialcost + stockmaster.overheadcost) AS gp 
                FROM stockmaster, 
                       stockmoves,
                       systypes 
                ...
                AND ((stockmoves.price*(1-stockmoves.discountpercent)) - (stockmaster.materialcost + stockmaster.overheadcost))/(stockmoves.price*(1-stockmoves.discountpercent)) <=" . ($_POST['GPMin']/100) . " 
