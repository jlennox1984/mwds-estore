...
if (isset($_SESSION['SupplierID'])){
	...
	echo "<BR><A HREF='$rootpath/PO_SelectOSPurchOrder2.php?" . SID . '&SelectedSupplier=' . $_SESSION['SupplierID'] . "'>" . _('Receive / Outstanding Negative Purchase Orders') . '</A>';
	...
	echo "<A HREF=\"$rootpath/SupplierInvoice2.php?" . SID . '&SupplierID=' . $_SESSION['SupplierID'] . "\">" . _('Enter a Negative Suppliers Invoice') . '</A><BR>';
