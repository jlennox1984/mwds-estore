...
echo "<P><A HREF='$rootpath/PO_SelectOSPurchOrder2.php?" . SID . "'>" . _('Create or received a negative purchase order') . '</A>';
echo "<P><A HREF='$rootpath/SelectSupplier2.php?" . SID . "'>" . _('Invoice negative purchase order') . '</A>';
